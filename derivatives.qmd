...
**Stretch:** Make another video discussing the Gradient Descent algorithm. Implement the Gradient Descent algorithm for a simple linear regression model with one variable. The dataset for the assignment is as follows:
